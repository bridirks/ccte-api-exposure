...
class ListPresenceRepositoryTest {
    @Container
    @ServiceConnection
    ...
    @Autowired private ListPresenceRepository repository;
    ...
    @Test
    void testDataLoaded() {
        assertThat(repository.findAll().size()).isEqualTo(23);
    }

    @Test
    void findByDtxsid() { assertThat(repository.findByDtxsid("DTXSID10883169")).isNotNull(); }
