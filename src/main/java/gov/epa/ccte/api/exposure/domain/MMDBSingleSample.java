...
public class MMDBSingleSample {
    ...
    @Schema(description = "Any reported concentration or sample result included in the raw data (any format)")
    ...
    @Size(max = 100)
    @Column(name = "nd_flag")
    @Schema(description = "Flag indicating if raw data indicated a measurement below limit of detection")
    private String detectionFlag;

    @Size(max = 500)
    @Column(name = "result_flag")
    @Schema(description = "Any reported flags associated with the reported concentrationresult in the raw data")
    ...
    @Size(max = 1000)
    @Column(name = "reported_analytical_method")
    @Schema(description = "Any reported analytical method information included in the raw data (any format)")
    ...
    @Size(max = 100)
    @Column(name = "reported_sample_id")
    @Schema(description = "Any reported sample ID reported in the raw data")
    private String sampleId;

    @Column(name = "mmdb_sample_id")
    @Schema(description = "Standardized sample ID issued for unique combinations of sample and source for single-sample data")
    private String mmdbSampleId;

    @Size(max = 45)
    @Column(name = "reported_dates")
    @Schema(description = "Any reported date of sample collection in the raw data (any format)")
    private String dates;

    @Size(max = 4)
    @Column(name = "sample_year")
    @Schema(description = "Year of sample collection")
    private String year;

    @Size(max = 4)
    @Column(name = "sample_month")
    @Schema(description = "Month of sample collection (any format)")
    private String month;

    @Column(name = "sample_time")
    @Schema(description = "Time of sample collection (any format)")
    private String time;
